...
check_unit "dag-caddy.service" ":8080" "https://$DOMAIN"
check_unit "dag-api.service" ":8000" "https://api.$DOMAIN"
check_unit "dag-mcp.service" ":8001" "https://mcp.$DOMAIN"
check_unit "dag-visualizer.service" ":8050" "https://viz.$DOMAIN"
check_unit "dag-tunnel.service" "outbound" "Cloudflare Edge Tunnel"
...
if [[ -n "${CLOUDFLARE_TUNNEL_TOKEN:-}" ]]; then
    ...
    echo "  Cloudflare Tunnel Token: Standby (Set CLOUDFLARE_TUNNEL_TOKEN in config/env)"
fi
